...
export const ui: Record<Locale, UiCopy> = {
  pt: {
    ...
    gatheringBody: "",
    gatheringMeta: [
      { label: "Análise à distância", value: "A primeira conversa e a análise inicial podem acontecer online, antes de qualquer viagem ou contratação local." },
      { label: "Coordenação no Brasil", value: "Mantemos contato com cartório, tradutores e profissionais envolvidos no processo brasileiro." },
      { label: "Viagem e celebração", value: "Quando o casal também deseja celebrar, organizamos hospedagem, transporte, cerimônia, fotografia e experiências no Rio." },
    ],
    dayKicker: "O método",
    giftsKicker: "O direito de dizer sim",
    giftsTitle: "O casamento civil pode ser o começo de uma experiência inesquecível.",
    giftsNote: "Vocês podem vir ao Brasil para oficializar a união e também viver esse momento em um dos cenários mais marcantes do Rio de Janeiro.\n\nA celebração pode ser íntima, apenas para o casal, ou incluir as pessoas que fizeram parte dessa história.",
