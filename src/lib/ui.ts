...
export const ui: Record<Locale, UiCopy> = {
  pt: {
    ...
    gatheringBody: "A primeira conversa e a análise inicial podem acontecer online, antes de qualquer viagem ou contratação local. Mantemos contato com cartório, tradutores e profissionais envolvidos no processo brasileiro. Quando o casal também deseja celebrar, organizamos hospedagem, transporte, cerimônia, fotografia e experiências no Rio.",
    gatheringMeta: [
      { label: "Análise à distância", value: "A primeira conversa e a análise inicial podem acontecer online." },
      { label: "Coordenação no Brasil", value: "Mantemos contato com cartório, tradutores e profissionais envolvidos." },
      { label: "Viagem e celebração", value: "Organizamos a experiência no Rio quando vocês desejarem celebrar." },
    ],
    dayKicker: "O método",
