...
const pt: Dictionary = {
  ...
  editorial: {
    ...
    body: "Nossa equipe organiza as etapas no Brasil e coordena o contato com cartório, tradução juramentada e suporte jurídico especializado, quando necessário. Cada caso é analisado individualmente. Os documentos, requisitos e prazos variam conforme o casal e o cartório responsável.",
  },
  since: {
    kicker: "Desde 2004",
    title:
  ...
  faq: {
    ...
    items: [
      { q: "O casamento entre pessoas do mesmo sexo é permitido no Brasil?", a: "Sim. A Resolução nº 175/2013 do Conselho Nacional de Justiça determina que as autoridades competentes não podem recusar a habilitação ou a celebração do casamento civil entre pessoas do mesmo sexo." },
      { q: "Dois estrangeiros podem se casar no Brasil?", a: "A possibilidade e os requisitos precisam ser analisados de acordo com a nacionalidade, o estado civil, o país de emissão dos documentos e o cartório responsável. A análise inicial serve para entender se o processo pode ser realizado e quais serão os próximos passos." },
      { q: "Nosso casamento será reconhecido no país onde moramos?", a: "O casamento produz efeitos no Brasil. O reconhecimento em outro país depende da legislação daquele país e deve ser confirmado com orientação jurídica local. O serviço não promete reconhecimento automático fora do Brasil." },
      { q: "Quais documentos serão necessários?", a: "A lista varia conforme o casal. Pode envolver certidões civis, documentos de identidade, comprovações de estado civil, apostilamento ou legalização e tradução juramentada. O checklist só deve ser definido depois da análise inicial." },
      { q: "Podemos realizar uma celebração além do casamento civil?", a: "Sim. Podemos combinar a coordenação do processo civil com um Elopement Wedding, uma cerimônia simbólica ou uma celebração com convidados no Rio de Janeiro." },
      { q: "Todo o planejamento pode ser feito à distância?", a: "Grande parte do processo pode ser coordenada online. A necessidade de presença no Brasil, os prazos e os atos presenciais são explicados depois da análise do caso e da confirmação pelo cartório responsável." },
    ],
  },
  finalCta: {
    title: "Contem um pouco sobre vocês.",
    body: "Para orientar o primeiro passo, precisamos entender onde vocês vivem, a nacionalidade e o estado civil de cada pessoa, os documentos disponíveis e quando imaginam vir ao Brasil. Esta conversa inicial também ajuda a identificar se vocês desejam apenas o casamento civil ou uma experiência completa no Rio.",
